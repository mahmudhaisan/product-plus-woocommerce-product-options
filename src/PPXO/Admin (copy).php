            ...
            <div class="ppxo-panel p-2 bg-white  rounded-3 shadow-sm">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <small class="text-muted"><?php _e('The content of this custom post will be injected into the selected WooCommerce product pages.', 'ppxo'); ?></small>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="ppxo-selected-header"><?php _e('Currently Selected Products (Saved)', 'ppxo'); ?></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select id="ppxo_hook" name="ppxo_hook" class="form-select">
                            <?php
                            $hooks = [
                                'woocommerce_before_add_to_cart_button'      => 'Before Add to Cart Button (Recommended)',
                                ...
                                'woocommerce_after_single_product_summary'   => 'After Product Summary (Below Main Content)',
                            ];
                        ...
                        <small class="text-muted"><?php _e('This setting controls exactly where the content appears on the front-end product page.', 'ppxo'); ?></small>
                    </div>
                </div>
...
<?php
    ...
    public function save_display_settings_meta($post_id)
    {
        ...
        if (isset($_POST['ppxo_products'])) {
            update_post_meta($post_id, '_ppxo_products', array_map('intval', $_POST['ppxo_products']));
        } else {
            delete_post_meta($post_id, '_ppxo_products');
        }


        if (isset($_POST['ppxo_hook'])) {
            update_post_meta($post_id, '_ppxo_hook', sanitize_text_field($_POST['ppxo_hook']));
        }
    }
